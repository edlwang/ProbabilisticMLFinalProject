...
```{figure} images/logistic_regression_train_confusion_plot.png
Confusion plot for the logistic regression model on the training dataset
```

```{figure} images/logistic_regression_test_confusion_plot.png
Confusion plot for the logistic regression model on the test dataset
```
